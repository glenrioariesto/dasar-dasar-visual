...
export function RuangKosongPage({ onBack, onCariTahu }: RuangKosongPageProps) {
  ...
  return (
    ...
    >
      ...
      <BackgroundFrame idPrefix="ruang-kosong" />
      ...
      >
        ...
        >
          {/* ===================================================================== */}
          {/* SISI KIRI: GAMBAR RUANG KOSONG (col-span-6)                           */}
          {/* ===================================================================== */}
          <div
            id="ruang-kosong-left-container"
            className="col-span-6 flex flex-col items-center justify-center h-full w-full min-h-0 relative"
          >
            <div
              id="ruang-kosong-img-wrapper"
            ...
            >
              <img
                id="ruang-kosong-left-img"
                src={ruangKosongIcon}
                alt="Ilustrasi Ruang Kosong"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Ruang kosong (white space atau negative space) adalah area bernapas di sekitar dan di antara elemen desain. Ruang kosong bukanlah area yang terbuang, melainkan elemen kunci yang memberi jeda visual, menegaskan fokus perhatian audiens pada informasi utama, dan menciptakan kesan karya yang lega, terstruktur rapi, serta berkelas tanpa rasa sesak.
                </p>
              </div>

              {/* 3. Button Cari Tahu */}
              <div
                id="ruang-kosong-btn-wrapper"
                className="w-full flex justify-center items-end shrink-0"
              >
                <button
                  id="ruang-kosong-btn-cari-tahu"
                  type="button"
      ...
      {/* Footer Area Kosong */}
      <footer id="ruang-kosong-footer" className="h-2 lg:h-4 z-20 shrink-0 pointer-events-none" />
    </div>
  );
}
