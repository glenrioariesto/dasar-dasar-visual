            ...
            >
              ...
              <div className="w-full flex-1 flex flex-col items-center justify-center my-auto px-2">
                <span
                  ...
                  className={`text-[#004760] leading-none transition-all duration-300 ${
                    fontSizeMode === 'large'
                ...
                <h4
                  style={{ fontFamily: activeFont.fontFamily }}
                  className="font-black text-xs sm:text-sm lg:text-base text-slate-800 mt-2 sm:mt-3 text-center leading-snug line-clamp-1"
                >
                ...
                <p
                  style={{ fontFamily: activeFont.fontFamily }}
                  className="text-[9px] sm:text-xs text-slate-600 text-center mt-1 max-w-xs line-clamp-2"
                >
              ...
              <div className="w-full flex items-center justify-between border-t border-slate-200 pt-1.5 text-[10px] sm:text-xs text-slate-600">
                <span className="font-bold text-[#004760] truncate max-w-[170px] sm:max-w-[200px]">
                  Aa Bb Cc 123 !?
                </span>
                <button
                  type="button"
