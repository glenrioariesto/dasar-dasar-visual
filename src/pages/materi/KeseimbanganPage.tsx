...
export function KeseimbanganPage({ onBack, onCariTahu }: KeseimbanganPageProps) {
  ...
  return (
    ...
    >
      ...
      <BackgroundFrame idPrefix="keseimbangan" />
      ...
      >
        ...
        >
          {/* SISI KIRI: GAMBAR KESEIMBANGAN (col-span-6) */}
          <div
            id="keseimbangan-left-container"
            className="col-span-6 flex flex-col items-center justify-center h-full w-full min-h-0 relative"
          >
            <div
              id="keseimbangan-img-wrapper"
            ...
            >
              <img
                id="keseimbangan-left-img"
                src={shotBalance}
                alt="Ilustrasi Keseimbangan"
          ...
          >
            ...
            >
              {/* 1. Judul Grafis 3D */}
              <div
                id="keseimbangan-title-wrapper"
                className="w-full flex justify-center items-start shrink-0 transition-transform duration-300 hover:scale-[1.02]"
              >
                <img
                  id="keseimbangan-title-img"
                  src={judulKeseimbangan}
                  alt="Keseimbangan"
                  className="w-auto max-w-[190px] sm:max-w-[260px] lg:max-w-[380px] 2xl:max-w-[450px] max-h-[14vh] lg:max-h-[17vh] 2xl:max-h-[20vh] h-auto object-contain drop-shadow-[0_8px_16px_rgba(0,161,219,0.25)]"
                />
              </div>

              {/* 2. Paragraf Deskripsi */}
              <div
                id="keseimbangan-desc-wrapper"
                className="w-full my-auto py-1 lg:py-2 flex items-center justify-center max-w-lg lg:max-w-xl 2xl:max-w-2xl"
              >
                <p
                  id="keseimbangan-description"
                ...
                >
                  Keseimbangan (balance) adalah prinsip menata bobot visual dari seluruh elemen desain—seperti warna, bentuk, ukuran, dan tekstur—agar karya terasa stabil, nyaman dipandang, dan tidak berat sebelah. Penataan keseimbangan yang baik menciptakan keselarasan yang memandu mata audiens menjelajahi seluruh informasi karya dengan runtut.
                </p>
              </div>

              {/* 3. Button Cari Tahu */}
              <div
                id="keseimbangan-btn-wrapper"
                className="w-full flex justify-center items-end shrink-0"
              >
                <button
                  id="keseimbangan-btn-cari-tahu"
                  type="button"
      ...
      {/* Footer Area Kosong */}
      <footer id="keseimbangan-footer" className="h-2 lg:h-4 z-20 shrink-0 pointer-events-none" />
    </div>
  );
}
